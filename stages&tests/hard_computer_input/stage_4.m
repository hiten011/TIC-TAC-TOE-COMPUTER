...
function [second] = second_move(recorded_moves, game)
    ...
    % for first move 8
    if recorded_moves(1) == 8 && recorded_moves(3) == 7 ||  recorded_moves(1) == 2 && recorded_moves(3) == 4
        second = 3;
        return;
    end

    if recorded_moves(1) == 2 && recorded_moves(3) == 1 ||  recorded_moves(1) == 2 && recorded_moves(3) == 3
        second = 5;
        return;
    end
